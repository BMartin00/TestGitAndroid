...
public class Dashboard
{
    ...
    public void openInventoryWindow()
    {
	    ...
	    scrollPane.setPreferredSize(new Dimension(900, 700)); // ✅ smaller fixed size
	    ...
	    centerPanel.add(scrollPane); // ✅ keeps the table centered
	    centerPanel.setLayout(new FlowLayout(FlowLayout.RIGHT, 40, 40)); // center alignment
	    ...
	    inventoryWindow.add(centerPanel, BorderLayout.CENTER); // ✅ use smaller centered table
